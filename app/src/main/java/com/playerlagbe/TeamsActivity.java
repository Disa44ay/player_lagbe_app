...
public class TeamsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teams_shared);

        // Check if user is logged in
        FirebaseAuthManager authManager = new FirebaseAuthManager(this);
        if (!authManager.isUserSignedIn()) {
            Intent intent = new Intent(TeamsActivity.this, AuthenticationActivity.class);
        ...
        bottomNavigationView.setSelectedItemId(R.id.nav_teams); // Set teams as selected
