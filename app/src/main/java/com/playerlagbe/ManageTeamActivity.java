    ...
    private void checkAdminAccess() {
        ...
        authManager.checkAdminStatus(new FirebaseAuthManager.AdminCheckListener() {
            ...
            public void onAdminCheckResult(boolean isAdmin) {
                if (!isAdmin) {
                    Toast.makeText(ManageTeamActivity.this, "Access denied. Admin only.", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
            ...
            public void onAdminCheckError(String error) {
                Toast.makeText(ManageTeamActivity.this, "Could not verify admin status. Access denied.", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
